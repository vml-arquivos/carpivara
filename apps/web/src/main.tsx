    ...
    <main>
      <section className="hero">
        <div className="heroContent">
          ...
          <div className="heroActions"><button className="primaryButton" onClick={() => onAccess('register')}>Criar conta gratuita <span>→</span></button><a className="secondaryButton" href="#como-funciona">Entender como funciona</a></div>
...
function App() {
  ...
  if (!token) return publicPage === 'landing' ? <Landing theme={theme} setTheme={setTheme} onAccess={(mode) => { setAuthMode(mode); setError(''); setPublicPage('auth'); }} /> : <AuthScreen onAuthenticated={setToken} onBack={() => setPublicPage('landing')} externalError={error} initialMode={authMode} />;

...
type AffiliateSelf = { affiliate: { id: string; name: string; email: string; code: string; commissionBps?: number; commission_bps?: number; active: boolean } | null; totals?: { pendingCents: number; paidCents: number; commissions: number } };
